...
pull_attempt=0
# until docker pull ghcr.io/hyperledger-solang/solang@sha256:8a9527c89f01f72ad88e6c13c9f099bcabc040ef24856cc616d56290fde98d3c; 
untill docker pull ghcr.io/hyperledger-solang/solang:latest; 
do
